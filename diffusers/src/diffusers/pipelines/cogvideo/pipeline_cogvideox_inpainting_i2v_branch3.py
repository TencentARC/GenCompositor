...
class CogVideoXI2VTriInpaintPipeline(DiffusionPipeline, CogVideoXLoraLoaderMixin):
    r"""
    ...
    def __call__(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            ...
            for i, t in enumerate(timesteps):
                ...
                latent_model_input = torch.cat([latent_video_input, fg_video_latents, masked_video_latents], dim=2)  # [1, 13, 32 + 16, 60, 90]
