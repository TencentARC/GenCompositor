...
def create_fg_video(ori_folder, mask_folder, output_video_path, output_video_path1, frame_rate=12):
    """
    ori_folder: original foreground frame
    mask_folder: binary mask frame
    output_video_path: mask video for save
    output_video_path1: foreground element video
    """
